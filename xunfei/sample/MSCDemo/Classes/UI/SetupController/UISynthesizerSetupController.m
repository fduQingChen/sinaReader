...
// set whether have the background music
// 设置合成过程中是否有背景音乐
- (void)bgSwitchValueChanged
{
	...
	{
		[_iFlySynthesizerControl setBackgroundSound:@""];
	}
	
}

// set the pronunciation people
// 设置发音人
- (void)personVoiceSegValueChanged
{
	...
	{
		[_iFlySynthesizerControl setVoiceName:@"vixr"];
	}
}
...
- (void)speedValueChanged
{
	NSLog(@"speed:%f",_speedVoiceSlider.value);
...
- (void)viewDidLoad 
{
	...
	_speedVoiceSlider.maximumValue = 10;
	_speedVoiceSlider.value = 5;
